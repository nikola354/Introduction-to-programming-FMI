...
### Основни предимства на функциите:
- преизползваемост на кода
- четимост
- разбиват сложните проблеми на по-прости
- улесняват дебъгването

### Правила на писане на функции:
- Името на функцията е добре да е глагол:
...
- Тялото на функцията не трябва да надвишава 40-50 реда (в редки случаи 60-70)
- Една функция трябва да прави ЕДНО нещо => ако имаме and в името на функцията, то е добре да я разделим на 2 функции:
